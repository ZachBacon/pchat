...
#define XCHAT_EAT_XCHAT		1	/* don't let PChat see this event */
...
void xchat_event_attrs_free (xchat_plugin *ph, xchat_event_attrs *attrs);
...
xchat_hook *
xchat_hook_server_attrs (xchat_plugin *ph,
		   const char *name,
		   int pri,
		   int (*callback) (char *word[], char *word_eol[],
							xchat_event_attrs *attrs, void *user_data),
...
xchat_hook *
xchat_hook_print_attrs (xchat_plugin *ph,
		  const char *name,
		  int pri,
		  int (*callback) (char *word[], xchat_event_attrs *attrs,
						   void *user_data),
...
#define xchat_event_attrs_create ((XCHAT_PLUGIN_HANDLE)->xchat_event_attrs_create)
#define xchat_event_attrs_free ((XCHAT_PLUGIN_HANDLE)->xchat_event_attrs_free)
#define xchat_hook_server ((XCHAT_PLUGIN_HANDLE)->xchat_hook_server)
#define xchat_hook_server_attrs ((XCHAT_PLUGIN_HANDLE)->xchat_hook_server_attrs)
#define xchat_hook_print ((XCHAT_PLUGIN_HANDLE)->xchat_hook_print)
#define xchat_hook_print_attrs ((XCHAT_PLUGIN_HANDLE)->xchat_hook_print_attrs)
...
#define xchat_emit_print_attrs ((XCHAT_PLUGIN_HANDLE)->xchat_emit_print_attrs)
