...
struct xchatprefs
{
	/* these are the rebranded, consistent, sorted xchat variables */
	...
	unsigned int pchat_gui_ulist_resizable;
	...
	char pchat_net_proxy_pass[32];
	char pchat_net_proxy_user[32];
