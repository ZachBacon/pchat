...
#define DBUS_REMOTE_CONNECTION_INTERFACE "org.pchat.connection"
#define DBUS_REMOTE_PLUGIN_INTERFACE "org.pchat.plugin"
...
main (int argc, char **argv)
{
	...
	/* Now you can write on the PChat windows: "/test arg1 arg2 ..." */
